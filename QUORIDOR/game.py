...
# rénitialisiation des paramètres  xx
...
#création de l'interface
    def start( self):       
        ...
        b5 = tk.Button(self.app, text ='Jouer avec la machine  ', command=self.jouerVsCpu)
        b5.place(x=10,y=posBt1)   
        # making a button which trigger the function so sound can be playeed
        # play_button = tk.Button(self.app, text="Play Song", font=("Helvetica", 32), relief=tk.GROOVE, command=self.play)
